...
typedef struct animatedTexture_s animatedTexture_t;
...
// animTex.frames must be in the texturebank of render
extern bool R_RenderAnimatedTexture(renderer_t* render, animatedTexture_t* animTex, SDL_Rect src, SDL_Rect dst);
